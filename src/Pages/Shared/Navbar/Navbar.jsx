  ...
  const navLinks = (
    <>
      <NavLink
        to={"/"}
        className={({ isActive }) =>
          isActive ? " bg-none text-[#EEFF25] font-bold" : ""
        }
      >
      ...
      <div className="navbar fixed z-10 bg-opacity-40  bg-black max-w-screen-xl">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <div
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[1] p-2 lg:text-white shadow bg-base-100 rounded-box w-52"
            >
              {navLinks}
            </div>
          </div>
          <a className=" normal-case text-xl text-center text-white">
            <span className="lg:text-2xl font-black">Bistro Boss</span> <br />{" "}
            <span className="lg:text-xl font-bold">Restaurant</span>
          </a>
        </div>
